...
from facilito.apps.adopciones.models import Persona, Solicitud
from facilito.apps.adopciones.forms import SolicitudForm, PersonaForm

# Create your views here.
def index(request):
    return HttpResponse("Index de adopciones")
...
class SolicitudUpdate(UpdateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        persona = self.second_model.objects.get(id=solicitud.persona.id)
